    ...
    <>
      <div className='w-full h-\[100px\] max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-700 '>
        <h1 className='text-white text-center my-3' >Password Generator</h1>
          <div className=' flex flex-col gap-1 shadow rounded-lg overflow-hidden mb-4 '>
                <div className=' flex '>
                  <input type="text"
                value={password}
                ...
                className='outline-none bg-blue-600 cursor-pointer text-white px-3 py-0.5 shrink-0'>
                  Copy</button>
                </div>
